		...
		<div class="container">
			<div class="row align-items-center gy-4">
				<div class="col-12 col-lg-7">
					<h1 class="display-5 fw-bold mb-3">Создание аккаунта</h1>
					<p class="lead">Зарегистрируйтесь, чтобы управлять новостями и
						получать доступ к дополнительным функциям.</p>
					<div class="d-flex gap-2 mt-3">
						<a class="btn btn-light btn-lg" href="/Controller/home">На
							главную</a> <a class="btn btn-outline-light btn-lg"
							href="/Controller/login">Войти</a>
					</div>
				</div>
				<div class="col-12 col-lg-5">
					<div class="card shadow-lg border-0">
						<div class="card-body">
							...
							<form action="/Controller/register" method="post" novalidate>
								<div class="mb-3">
								...
								<div class="mb-3">
									<label for="password" class="form-label">Пароль</label> <input
										...
										class="form-control" placeholder="••••••••" minlength="6"
										required>
								</div>
								<div class="mb-3">
									<label for="confirmPassword" class="form-label">Подтверждение
										пароля</label> <input type="password" id="confirmPassword"
								...
								<div class="form-check mb-3">
									<input class="form-check-input" type="checkbox" id="terms"
										...
										Я принимаю условия использования </label>
								</div>
								<div class="d-flex justify-content-between align-items-center">
									<a href="/Controller/home" class="text-decoration-none">На
										главную</a>
							...
							<hr class="my-4">
							<div class="d-flex justify-content-between align-items-center">
								<span class="text-muted">Уже есть аккаунт?</span> <a
									class="btn btn-outline-primary" href="/Controller/login">Войти</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row gy-3 align-items-center">
				...
				<div class="col-12 col-md text-md-end">
					<a class="text-decoration-none text-light me-3"
						...
						class="text-decoration-none text-light" href="/Controller/login">Войти</a>
				</div>
			</div>
		</div>
	</footer>
